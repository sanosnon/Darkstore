...
let products = JSON.parse(localStorage.getItem("products")) || [
  { id: 1, name_en: "Cargo Pants", name_ar: "بنطال كارغو", price: 45, category: "pants", img:"images/pants.jpg", status: "", stock: 10 },
  { id: 2, name_en: "Slim Jeans", name_ar: "بنطال جينز", price: 60, category: "pants", img:"images/pants.jpg", status: "", stock: 8 },
  { id: 3, name_en: "Running Shoes", name_ar: "حذاء جري", price: 85, category: "footwear", img:"images/footwear.jpg", status: "", stock: 0 },
  { id: 4, name_en: "Winter Boots", name_ar: "جزمة شتوي", price: 95, category: "footwear", img:"images/footwear.jpg", status: "", stock: 5 },
  { id: 5, name_en: "Black Balaclava", name_ar: "بالاكلافا أسود", price: 20, category: "balaclava", img:"images/balaclava.jpg", status: "", stock: 12 },
  { id: 6, name_en: "Thermal Balaclava", name_ar: "بالاكلافا حراري", price: 25, category: "balaclava", img:"images/balaclava.jpg", status: "", stock: 0 }
];
...
function updateQty(id, value){
  ...
  if(item && product){
    ...
    if(qty>product.stock) {
      alert(lang==="en"?"Cannot exceed stock":"لا يمكن زيادة الكمية عن المخزون");
      qty = product.stock;
    }
    item.qty = qty;
  }
...
if(checkoutForm){
  checkoutForm.addEventListener("submit",(e)=>{
    ...
    // ====== حفظ الطلب في Orders مع كل بيانات العميل ======
    ...
    if(cartItemsDiv) renderCartItems();
    if(orderSummaryDiv) renderOrderSummary();
    if(productGrid) renderProducts(products); // تحديث المنتجات بعد خصم المخزون
    checkoutForm.reset();
  });
}